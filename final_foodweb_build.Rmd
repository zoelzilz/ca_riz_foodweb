...
## edges ##
edges_unclean <- read_csv("data/edges_frommaster_6may2024.csv") %>% # updated again, as above
...
write_csv(nodes_attributes_clean, "data/foodweb_V3/nodes_final_3may2024.csv")

write_csv(edges_clean, "data/foodweb_V3/links_final_3may2024.csv")
...
trophic_web_psites1 <- graph_from_data_frame(d= trophic_links, # all links
