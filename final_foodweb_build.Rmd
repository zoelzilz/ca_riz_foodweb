...
## edges ##
edges_unclean <- read_csv("data/edges_frommaster_2jun2024.csv") %>% # updated again, as above
...
write_csv(nodes_attributes_clean, "data/foodweb_V4/nodes_final_2jun2024.csv")

write_csv(edges_clean, "data/foodweb_V4/links_final_2jun2024.csv")
