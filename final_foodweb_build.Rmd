...
## nodes ##
potential_nodes <- read_csv("data/RIZspecieslist_fulltaxonomy_24apr24.csv") %>% # updated to .1 version because I had to manually fix some higher taxonomy, then updated to 4/24 version because I fixed metadata of some dissection nodes
  rename(nodeNum = id.x)
...
## edges ##
edges_unclean <- read_csv("data/edges_frommaster_24apr2024.csv") %>% # updated to 4/24 version because I had forgotten to include dissection data
...
write_csv(nodes_attributes_clean, "data/foodweb_V2/nodes_final_24apr2024.csv")

write_csv(edges_clean, "data/foodweb_V2/edges_final_24apr2024.csv")
...
write_csv(resources_without_food, "data/nodes_needing_resources_24apr2024.csv")
